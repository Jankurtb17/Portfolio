<template>
  ...
  <div class="description sm:px-3 sm:py-4">
    <p class="text-center text-white leading-loose">
      from Batanes, Philippines. I have a 2-year experience  in web development. I love to <br> talk with you about your unique.
    </p>
  </div>
  <div class="contact-icon sm:flex sm:justify-center gap-3 mb-10">
    <img class="h-8" src="../assets/svg/linkedin.svg" />
    <img class="h-8" src="../assets/svg/facebook.svg" />
    <img class="h-8" src="../assets/svg/insta.svg" />
  </div>
  <div class="btn-csv sm:flex sm:justify-center">
